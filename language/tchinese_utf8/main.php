...
define('TF_LOGO_BG', 'logo區域的底圖');
define('TF_LOGO_BG_DESC', '若「是」會在logo區域加上底圖');
define('TF_LOGO_BG_REPEAT', 'logo底圖重複方式');
define('TF_LOGO_BG_REPEAT_DESC', 'logo底圖重複的方式');
define('TF_LOGO_POSITION', 'logo底圖位置');
define('TF_LOGO_POSITION_DESC', 'logo底圖起始的位置');
